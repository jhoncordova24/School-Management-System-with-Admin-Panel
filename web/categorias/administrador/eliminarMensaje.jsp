...
<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <div class="form">
                <%
                    String mensajeIdStr = request.getParameter("id");
                    if (mensajeIdStr != null && !mensajeIdStr.isEmpty()) {
                        int mensajeId = Integer.parseInt(mensajeIdStr);
                        Connection con = null;
                        PreparedStatement ps = null;

                        try {
                            con = AccesoBD.getConnection();
                            ps = con.prepareStatement("DELETE FROM contacto WHERE id_contacto = ?");
                            ps.setInt(1, mensajeId);
                            int filasEliminadas = ps.executeUpdate();

                            if (filasEliminadas > 0) {
                                response.sendRedirect("adminContacto.jsp");
                            } else {
